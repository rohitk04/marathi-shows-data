...
if (ch==1):
    ...
    # process("2 Hour Special Episode", 'data/json/2_hours_special_episode/2_hours_special_episode_backup.json', 'data/json/2_hours_special_episode/2_hours_special_episode.json', 'shows')
